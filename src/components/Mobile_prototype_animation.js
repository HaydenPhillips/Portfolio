...
const Mobile_prototype_animation = () => {
  ...
  return (
    <Fragment>
      <div className="png">
        <animated.img src={recipient_selected} id='recipient_selected' style={fade_downRight_select} />
      </div>

      <div className="png">
        <animated.img src={phone_main} id='phone_main' style={fade_downRight_main} />
      </div>

      <div className="png">
        <animated.img src={phone_home_screen} id='phone_home_screen' style={fade_upLeft_home} />
      </div>

      <div className="png">
        <animated.img src={contact_dropdown} id='contact_dropdown' style={fade_upLeft_dropdown} />
      </div>
    </Fragment >

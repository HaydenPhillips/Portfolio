          ...
          <div className="left">
            <Slug delay={400}>
              ...
              <div className="row">
                ...
                <div className="text">
                  Bachelor of Science | Computer Science Major | BSc | 2016 –
                  2020
                </div>
              </div>
              <div className="row">
              ...
              <div className="row">
                ...
                <div className="text">
                  ...
                  Engineering, User Interface Design, Computer Graphics,
                  Advanced Data Structures & Algorithms, Software Correctness,
                  Safety Critical Systems, Systems Programming, Engineering
                  Modelling & Design, Computer Networks, Compilers &
                  Interpreters. Business: Blockchain Bootcamp, Project
                  Management, Digital Innovation & Enterprise. Mathematics:
                  Mathematical Thinking, Engineering Math foundations,
                  Engineering Math with logic and stats. Physics: Intro to
                  Physics, Physics for Electronics, Engineering Science.
                </div>
              </div>
            </Slug>
          </div>

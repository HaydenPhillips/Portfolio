...
const ProjectRoy = () => {
    ...
    const someString = 'Motion - a short film following the design and creation of the unique reversible collection.'

    return (

        <Fragment>
            <Parallax pages={8} ref={ref => parallax = ref}
                style={{
                    display: 'flex',
                    maxWidth: '1920px',
                    margin: 'auto'
                ...
                <div className='wrapper'>
                    ...
                    /> */}
                    <ParallaxLayer onClick={() => parallax.scrollTo(1)} offset={0} speed={-0.2}
                        style={{
                            display: 'flex',
                            alignItems: 'center',
                    ...
                    <ParallaxLayer onClick={() => parallax.scrollTo(5)} offset={3} speed={0.5}
                        style={{
                    ...
                    <div className='pad'>
                        <ParallaxLayer offset={0.0} speed={1}
                            style={{
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center'
                        ...
                        <div className='aline-center'>
                            <ParallaxLayer offset={3.1} speed={1}
                                ...
                                <div className='header'>
                                    <h1>NAVY LS<br /> REVERSIBLE</h1>
                                </div>
                            </ParallaxLayer>
                            <ParallaxLayer offset={3.1} speed={0.8}
                                style={{
                                    position: 'static',
                                    display: 'flex',
                                    alignItems: 'center',
                                ...
                                <div className='text-50'>
                                    <p>A completely reversible shirt designed with wearability and functionality in mind. Crafted by masters of the trade, using complex construction methods with precise symmetry. This provides an easy care shirt that is resistant to creasing, fast drying, while maintaining a soft lightweight feel.</p>
                                </div>
                            </ParallaxLayer>
                        </div>
                        ...
                        <ParallaxLayer offset={4} speed={0.8}
                            ...
                            <div className='text'>
                                <p>The weave of the fabric is key to its many benefits, the highly twisted polyester yarn gives the material a slight spring, that aids in making the shirt very resistent to creasing. The naturally hydrophobic qualities of polyester means it is resistent to water, resulting in a very fast drying shirt.
                                    </p>
                            </div>
                        </ParallaxLayer>


                        <ParallaxLayer onClick={() => parallax.scrollTo(3)} offset={5.2} speed={0.5}
                            style={{ backgroundColor: 'lightgrey' }}
                        />
